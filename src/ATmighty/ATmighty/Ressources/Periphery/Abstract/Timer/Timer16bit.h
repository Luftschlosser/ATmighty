/*
 * This headerfile represents a common interface for all 16bit Timers. (abstract and virtual)
 */

#ifndef ATMIGHTY_RESSOURCES_PERIPHERY_ABSTRACT_TIMER_TIMER16BIT_H_
#define ATMIGHTY_RESSOURCES_PERIPHERY_ABSTRACT_TIMER_TIMER16BIT_H_
...
///This class represents a pure virtual common interface for all 16bit Timers
class Timer16bit
{
	...
	public:
		 ...
		 * All 16-bit timers will support potencys 0[1], 3[8], 6[64], 8[256], 10[1024]. Asynchronous timers support additionally 5[32] and 7[128].
		...
		virtual void setCounter(uint16_t value) = 0;

		/// Returns the current value of the timer-counter.
		virtual uint16_t getCounter() = 0;
		 ...
		 */
		virtual int8_t setOCRx(uint16_t value, char channel) = 0;
		 ...
		 */
		virtual int8_t setExtClockInput(EdgeTrigger trigger) = 0;
		...
		virtual void setInputCaptureValue(uint16_t value) = 0;

		/// Returns the current value of the input-capture register.
		virtual uint16_t getInputCaptureValue() = 0;
		 ...
		 * Enum type EdgeTrigger is provided for easier usage, else trigger: 0==falling, 1==rising.
		 */
		virtual void setInputCaptureTrigger(EdgeTrigger trigger) = 0;
		 ...
		 */
		virtual void enableInputCaptureNoiseFilter(bool value) = 0;
		 ...
		 */
		virtual IoPin* getInputCapturePin() = 0;
		 ...
		 * \param value true to enable the interrupt, false to disable the interrupt.
		 */
		virtual void enableInputCaptureInterrupt(bool value) = 0;
		 ...
		 * \param isr the Listener-object which will be triggered to serve as interrupt-service-routine.
		 */
		virtual void setInputCaptureISR(Listener* isr) = 0;
		 ...
		 * \param isr the functionpointer which will be called to serve as interrupt-service-routine.
		 */
		virtual void setInputCaptureISR(void (*isr)()) = 0;
	...
	protected:
		...
		{
			static const char me[] PROGMEM = "Timer16bit";
			return me;
		}
};


#endif /* ATMIGHTY_RESSOURCES_PERIPHERY_ABSTRACT_TIMER_TIMER16BIT_H_ */
