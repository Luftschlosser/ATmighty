...
class AbstractTimer0 final : public AbstractTimer8bit
{
	...
	private:
		...
		static SpecificIoPin<'B',7>* OutputA;
		static SpecificIoPin<'G',5>* OutputB;
		static SpecificIoPin<'D',7>* ExtClk;

		///Default Constructor
		inline AbstractTimer0() : physicalReference(nullptr) {}
