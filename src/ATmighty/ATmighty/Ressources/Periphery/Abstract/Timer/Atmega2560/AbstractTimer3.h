/*!
 * This headerfile represents an abstract wrapper for physical Timer3 of the ATmega2560
 * This headerfile is µC-dependent, it should only be included indirectly via "Timer.h".
 */

#ifndef ATMIGHTY_RESSOURCES_PERIPHERY_ABSTRACT_TIMER_ATMEGA2560_ABSTRACTTIMER3_H_
#define ATMIGHTY_RESSOURCES_PERIPHERY_ABSTRACT_TIMER_ATMEGA2560_ABSTRACTTIMER3_H_
...
class AbstractTimer3 : public AbstractTimer16bit
{
	...
	private:
		...
		///A reference to the physical Timer3-instance wrapped by this AbstractTimer3
		Timer3* physicalReference;
		...
		static SpecificIoPin<'E',3>* OutputA;
		static SpecificIoPin<'E',4>* OutputB;
		static SpecificIoPin<'E',5>* OutputC;
		static SpecificIoPin<'E',6>* ExtClk;
		static SpecificIoPin<'E',7>* Icp; //Input capture Pin

		///Default Constructor
		inline AbstractTimer3() : physicalReference(nullptr) {}
	...
	public:
		...
		inline char getCharCode() {return '3';}
};


#endif /* ATMIGHTY_RESSOURCES_PERIPHERY_ABSTRACT_TIMER_ATMEGA2560_ABSTRACTTIMER3_H_ */
